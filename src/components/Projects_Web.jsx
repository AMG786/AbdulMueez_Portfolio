...
const ProjectCard = ({
  ...
  return (
      <motion.div
          ...
          whileHover={{ scale: 1.05, rotate: 1 }} // Add hover scaling and subtle rotation
          ...
          <div className='absolute inset-0 flex justify-end m-3 card-img_hover gap-2'>
            {live_link && (
              <div
                ...
                title='Live demo'
              >
                <img src={play} alt='live demo' className='w-1/2 h-1/2 object-contain' />
              </div>
            )}
            {source_code_link && (
              <div
...
export default SectionWrapper(Projects_Web, "");